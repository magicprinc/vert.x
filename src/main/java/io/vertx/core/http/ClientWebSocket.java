...
public interface ClientWebSocket extends WebSocket {
   ...
   */
  Future<Void> connect(WebSocketConnectOptions options);
   ...
   * @return a future notified when the WebSocket when connected
   */
  default Future<Void> connect(int port, String host, String requestURI) {
   ...
   * @return a future notified when the WebSocket when connected
   */
  Future<Void> connect(String host, String requestURI);
   ...
   * @return a future notified when the WebSocket when connected
   */
  Future<Void> connect(String requestURI);
   ...
   * @return a future notified when the WebSocket when connected
   */
  Future<Void> connect(String url, MultiMap headers, WebsocketVersion version, List<String> subProtocols);
