...
public class ClientWebSocketImpl implements ClientWebSocket {
  ...
  @Override
  public Future<Void> connect(WebSocketConnectOptions options) {
  ...
  @Override
  public Future<Void> connect(String host, String requestURI) {
    return connect(client.options.getDefaultPort(), host, requestURI);
  }

  @Override
  public Future<Void> connect(String requestURI) {
    return connect(client.options.getDefaultPort(), client.options.getDefaultHost(), requestURI);
  }

  @Override
  public Future<Void> connect(String url, MultiMap headers, WebsocketVersion version, List<String> subProtocols) {
